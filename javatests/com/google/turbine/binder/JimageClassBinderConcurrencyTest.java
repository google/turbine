...
public class JimageClassBinderConcurrencyTest {
  ...
  @Test
  public void nullModule() throws Exception {
    ClassPath binder = JimageClassBinder.bindDefault();
    assertThat(binder.moduleEnv().get(new ModuleSymbol("nonexistent.module"))).isNull();
  }

  @Test
  public void nullPackage() throws Exception {
    ClassPath binder = JimageClassBinder.bindDefault();
    assertThat(binder.index().lookupPackage(ImmutableList.of("nonexistent", "package"))).isNull();
  }
}
